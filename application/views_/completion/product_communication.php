...
<div class="col-md-12 col-sm-12" style="background-color:white">
	...
	<div class="col-md-12 pad-0">
		...
		<p class="darkblue-font title_completion page_title"></p>
	...
	<div class="col-md-12 content-item no-padding" style="margin-bottom: 20px;">
...
start_ojl('product_communication_data');
