		...
		//echo '<pre>'; print_r($itenerary);
		 ...
		 foreach($agenda as $value) {
		 		...
		 		if($date_from == $date_to) {
		 			$date_of_ojl = date_format($datefrom, 'F d, Y');
		 		} else {
		...
		if(user == 'psr') {
			...
			$.ajax({
				...
				$.ajax({
					...
					bootbox.alert("<b>The OJL Report has been forwarded to Training Department.</b>");
					//location.reload();
				})
...
<div class="col-md-12 new_version_container" style="background-color:white">
	<div class="col-md-12">
		...
		<div class="col-md-10" style="margin-bottom:10px;">
			...
			<p class="darkblue-font" style="font-size:50px">VIEW</p>
		</div>
	</div>
		...
		<div class="responsive col-sm-12 col-md-12 col-lg-12 margin-top-20px no-padding">
			<table class="sales_plan_tbl col-sm-12 col-md-12 col-lg-12 no-padding"> 
				<thead class="darkblue-bg">
					<tr>
						<th><?=$datefrom_;?></th>
						<th>Name of MD/Client</th> 
						<th>Biomedis Product</th> 
						<th> Rating per MD </th> 
						<th> Remarks </th> 
